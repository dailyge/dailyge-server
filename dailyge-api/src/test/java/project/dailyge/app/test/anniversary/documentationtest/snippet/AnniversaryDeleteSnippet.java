...
public final class AnniversaryDeleteSnippet implements AnniversarySnippet {

    private static final String SUMMARY = "Anniversary 삭제 API";
    private static final String DESCRIPTION = "Anniversary를 삭제합니다.";

    private AnniversaryDeleteSnippet() {
        throw new AssertionError("올바른 방식으로 생성자를 호출해주세요.");
    }

    public static RestDocumentationFilter createDeleteAnniversaryFilter(final String identifier) {
        return document(
            identifier,
