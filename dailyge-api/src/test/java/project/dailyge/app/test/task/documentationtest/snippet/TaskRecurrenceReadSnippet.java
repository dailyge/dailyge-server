...
public class TaskRecurrenceReadSnippet implements TaskSnippet {

    private static final String SUMMARY = "반복 일정 조회 API";
    private static final String DESCRIPTION = "사용자의 반복 일정 정보를 조회합니다.";

    private TaskRecurrenceReadSnippet() {
