...
class CodeAndMessageUnitTest {
    ...
    @Test
    @DisplayName("빌더 패턴을 통해 CodeAndMessage 객체를 생성할 수 있다.")
    void whenCreateCodeAndMessageWithBuilderPatternThenObjectShouldBeNotNull() {
        final CodeAndMessageJpaEntity entity = CodeAndMessageJpaEntity.builder()
            .code(400)
            .name("BAD_REQUEST")
    ...
    void whenCreateCodeAndMessageWithStaticMethodThenObjectShouldBeNotNull() {
        final CodeAndMessageJpaEntity entity = CodeAndMessageJpaEntity.create(
            "common",
            "BAD_REQUEST",
            400,
            "올바른 파라미터를 입력해주세요."
    ...
    void whenUpdateSourceThenResultShouldBeSameAsTarget() {
        final CodeAndMessageJpaEntity source = CodeAndMessageJpaEntity.create(
            "common",
            "BAD_REQUEST",
            400,
            "올바른 파라미터를 입력해주세요."
        ...
        final CodeAndMessageJpaEntity target = CodeAndMessageJpaEntity.create(
            "common",
