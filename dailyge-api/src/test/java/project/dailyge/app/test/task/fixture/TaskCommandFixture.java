...
public final class TaskCommandFixture {
    ...
    public static TaskCreateCommand createTaskCreationCommand(final LocalDate now) {
    ...
    public static TaskUpdateCommand createTaskUpdateCommand(final LocalDate now) {
