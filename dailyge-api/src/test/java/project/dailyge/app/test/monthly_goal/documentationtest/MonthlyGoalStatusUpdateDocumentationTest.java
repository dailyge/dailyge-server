...
import static project.dailyge.app.test.monthly_goal.documentationtest.snippet.MonthlyGoalUpdateSnippet.updateMonthlyGoalStatusFilter;
...
class MonthlyGoalStatusUpdateDocumentationTest extends DatabaseTestBase {
    ...
    void whenUpdateMonthlyGoalStatusThenStatusCodeShouldBe200_RestDocs() throws JsonProcessingException {
        ...
        given(this.specification)
            ...
            .put("/api/monthly-goals/{monthlyGoalId}/status", monthlyGoalId)
            .then()
            .statusCode(200)
            .log()
            .all();
    ...
    void whenUpdateMonthlyGoalStatusWithInvalidParameterThenStatusCodeShouldBe400_Swagger() throws JsonProcessingException {
        ...
        given(this.specification)
            ...
            .header(AUTHORIZATION, getAuthorizationHeader())
            .body(objectMapper.writeValueAsString(request))
            .put("/api/monthly-goals/{monthlyGoalId}/status", "invalidId")
            .then()
            .statusCode(400)
            .log()
            .all();
    ...
    void whenUpdateMonthlyGoalStatusButNotExistsThenStatusCodeShouldBe404() throws JsonProcessingException {
        ...
        given(this.specification)
            ...
            .header(AUTHORIZATION, getAuthorizationHeader())
            .body(objectMapper.writeValueAsString(request))
            .put("/api/monthly-goals/{monthlyGoalId}/status", 300)
            .then()
            .statusCode(404)
            .log()
            .all();
